...
def gradient_function(output_vector,z,theta,i):
    return v.scaler_product((v.dotproduct(theta,z[i])-output_vector[i]),z[i])

def sgd_static_alpha(output_vector,input_matrix,learning_rate=0.01,epoch=100):
    return trainers.sgd_alpha_const(output_vector,input_matrix,gradient_function,learning_rate,epoch)
...
def batch_const_alpha(output_vector,input_matrix,alpha,batch_size=500,epoch=100):
    return trainers.batch_const_alpha(output_vector,input_matrix,gradient_function,alpha,batch_size,epoch)
